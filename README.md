...
<h3 align="center">Bankist</h3>
  ...
  <p align="center">
    demo banking app
    <br />
    <a href="https://github.com/DevTruce/bankist" target="_blank"><strong>Explore the docs »</strong></a>
    <br />
    <br />
    <a href="https://devtruce.github.io/bankist/" target="_blank">View Demo</a>
    ·
    <a href="https://github.com/DevTruce/bankist/issues" target="_blank">Report Bug</a>
    ·
    <a href="https://github.com/DevTruce/bankist/issues" target="_blank">Request Feature</a>
  </p>
</div>
...
[![Bankist User1 Screen Shot][product-screenshot2]](product-link)
[![Bankist User2 Screen Shot][product-screenshot3]](product-link)
[![Bankist Login Screen Shot][product-screenshot1]](product-link)

The Bankist project was very insightful and enjoyable to work on. This is NOT a real app!
This was a learning project that helped to solidify current concepts as well and take on and learn new concepts.

Here are some features that are available within the Bankist app.

- login / logout
- live update of funds in/out
...
[issues-link]: https://github.com/DevTruce/bankist/issues
[license-link]: https://github.com/DevTruce/bankist/blob/master/LICENSE.txt
...
[issues-icon]: https://img.shields.io/github/issues/DevTruce/bankist.svg?style=for-the-badge
[license-icon]: https://img.shields.io/github/license/DevTruce/bankist.svg?style=for-the-badge
